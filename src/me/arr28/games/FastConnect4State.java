...
public class FastConnect4State implements GameState {
     ...
     * +---------------------+
     */
    private static final int WIDTH = 8; // Max supported = 8
    ...
    private boolean isTerminal(long xiBoard) {
        if ((xiBoard & (xiBoard >> 6) & (xiBoard >> 12) & (xiBoard >> 18)) != 0)
            return true; // diagonal \
        if ((xiBoard & (xiBoard >> 8) & (xiBoard >> 16) & (xiBoard >> 24)) != 0)
            return true; // diagonal /
        if ((xiBoard & (xiBoard >> 7) & (xiBoard >> 14) & (xiBoard >> 21)) != 0)
            return true; // horizontal
        if ((xiBoard & (xiBoard >> 1) & (xiBoard >> 2) & (xiBoard >> 3)) != 0)
